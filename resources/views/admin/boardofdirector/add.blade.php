        ...
        <div class="col-sm-12">
            <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.boardsofdirector.add') }}">Add</a></li>
                </ol>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.boardsofdirector.store') }}" enctype="multipart/form-data">
                        @csrf
