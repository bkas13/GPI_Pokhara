        ...
        <div class="col-sm-12">
            <div class="float-right page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item "><a href="{{ route('admin.boardsofdirector.all') }}">Board Of Directors</a></li>
                    <li class="breadcrumb-item "><a href="{{ route('admin.staff.details',$staff->slug) }}">{{ $staff->name }}</a></li>
                    <li class="breadcrumb-item active"><a href="{{ route('admin.boardsofdirector.edit',$staff->slug) }}">Info</a></li>
                </ol>
            </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.boardsofdirector.update',$staff->slug) }}" enctype="multipart/form-data">
                        @csrf
