        ...
        <div class="card m-b-25">
            <div class="card-body">
                <div class="row mt-2 mb-3">
                    <div class="col-md-6">
                        <h4 class="mt-2 ml-3 header-title">Add FAQ</h4>

                    </div>
                    <div class="col-md-6 text-md-right">
                        <a href="{{ route('admin.faq.all') }}" class="btn btn-primary" type="button">
                            Back to all FAQ's
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-8 ml-0">
                    <form action="{{ route('admin.faq.editSubmit',$faq->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @include('admin.faq.commonform')
