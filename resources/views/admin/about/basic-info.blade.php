                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ getAbout('name') }}" name="name" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image_preview">
                                        <div class="z-depth-1-half mb-4" style="text-align: center;">
                                            <img style="width: 100px;" id="preview_logo"
                                                src="{{ asset('thumbnail/' . getAbout('logo')) }}"
                                                class="avatar-pic img-fluid" title="Click To Upload news Photo"
                                                alt="news Image">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image_preview">
                                        <div class="z-depth-1-half mb-4" style="text-align: center;">
                                            <img style="width: 100px;" id="preview_favicon"
                                                src="{{ asset('thumbnail/' . getAbout('favicon')) }}"
                                                class="avatar-pic img-fluid" title="Click To Upload news Photo"
                                                alt="news Image">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ getAbout('facebook_link') }}" name="facebook_link"
                                        class="form-control" required placeholder="Facebook Link " />
                                </div>


                                <div class="form-group">
                                    <label>{{ getLanguage('youtube') . ' ' . getLanguage('link') }}</label>
                                    <input type="text" value="{{ getAbout('youtube_link') }}" name="youtube_link"
                                        class="form-control" required placeholder="Youtube Link " />
                                </div>


                                <div class="form-group">
                                    <label>{{ getLanguage('twitter') . ' ' . getLanguage('link') }}</label>
                                    <input type="text" value="{{ getAbout('twitter_link') }}" name="twitter_link"
                                        class="form-control" required placeholder="Twitter Link " />
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" value="{{ getAbout('address') }}"
                                        class="form-control" required placeholder="Address" />
                                </div>

                                <div class="form-group">
                                    <label>{{ getLanguage('school') . ' ' . getLanguage('phone') }}</label>
                                    <input type="text" name="phone" value="{{ getAbout('phone') }}" class="form-control"
                                        placeholder="Phone Number" />
                                </div>

                                <div class="form-group">
                                    <label>{{ getLanguage('school') . ' ' . getLanguage('email') }}</label>
                                    <input type="email" name="email" value="{{ getAbout('email') }}" class="form-control"
                                        placeholder="Email" />
                                </div>

                                <div class="form-group">
                                    <label>{{ getLanguage('province-number') }}</label>
                                    <input type="number" name="province_number" value="{{ getAbout('province_number') }}"
                                        class="form-control" placeholder="Province Number" />
                                </div>
                                <div class="form-group">
                                    <label>{{ getLanguage('vdc-municipality-name') }}</label>
                                    <input type="text" name="vdc_name" value="{{ getAbout('vdc_name') }}"
                                        class="form-control" placeholder="Name" />
                                </div>
                                <div class="form-group">
                                    <label>{{ getLanguage('vdc-municipality-address') }}</label>
                                    <input type="text" name="vdc_address" value="{{ getAbout('vdc_address') }}"
                                        class="form-control" placeholder="Address" />
                                </div>
                                <div class="form-group">
                                    <label>{{ getLanguage('vdc-municipality-phone') }}</label>
                                    <input type="text" name="vdc_phone" value="{{ getAbout('vdc_phone') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image_preview">
                                        <div class="z-depth-1-half mb-4" style="text-align: center;">
                                            <img style="width: 100px;" id="preview_vdc"
                                                src="{{ asset('thumbnail/' . getAbout('vdc_logo')) }}"
                                                class="avatar-pic img-fluid" title="Click To Upload news Photo"
                                                alt="news Image">
                                        </div>
                                    </div>
