            ...
            <div class="modal-body">
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" required placeholder="Slider {{ getLanguage('title') }}" required/>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" class="form-control" required placeholder="Slider {{ getLanguage('image') }}" required/>
                    </div>
