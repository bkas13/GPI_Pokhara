    ...
    <div class="sidebar-inner slimscrollleft">
        ...
        <div id="sidebar-menu">
            <ul>
                ...
                <li class="has_sub">
                    <a href="" class="waves-effect"><i class="dripicons-folder-open"></i> <span>Courses</span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                    <ul class="list-unstyled">
                        <li><a href="{{route('admin.course_category.all')}}">Course Category</a></li>
                        <li><a href="{{ route('admin.course.all') }}">All Courses</a></li>
                    </ul>
                </li>

                <li>
                    <a href="{{ route('admin.message.allmessages') }}" class="waves-effect">
                        <i class="dripicons-mail"></i>
                        <span> Messages </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.faq.all') }}" class="waves-effect">
                        <i class="dripicons-question"></i>
                        <span> FAQ </span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.boardsofdirector.all') }}" class="waves-effect">
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('admin.career.all') }}">Careers</a></li>
