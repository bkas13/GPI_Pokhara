        ...
        <div class="card m-b-25">
            <div class="card-body">
                <div class="row mt-2 mb-3">
                    <div class="col-md-6">
                        <h4 class="mt-2 ml-3 header-title">Edit Course Categories</h4>

                    </div>
                    <div class="col-md-6 text-md-right">
                        <a href="{{ route('admin.course_category.all') }}" class="btn btn-primary" type="button">
                ...
                <div class="col-md-8 ml-0">
                    <form action="{{ route('admin.course_category.editSubmit',$courseCategory->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @include('admin.course_category.commonform')
