                            ...
                            <div class="notice-detail-wrapper">
                                ...
                                <ul>
                                    @if (isset($tender->file))
                                        <iframe
                                            src="http://docs.google.com/gview?url={{ asset($tender->file) }}&amp;embedded=true"
                                        ...
                                        <li>
                                            ...
                                            <div class="download-icon">
                                                <a href="{{ asset($tender->file) }}" target="_blank"> <i
                        ...
                        @if ($context->recent_tenders->isNotEmpty())
                            <ul>
                                @foreach ($context->recent_tenders as $tend)
                                    <li>
                                        <a
                                            href="{{ route('front.singleTender', [$tend->id, getNepaliDate($tend->created_at)]) }}">{{ $tend->title }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        @else
