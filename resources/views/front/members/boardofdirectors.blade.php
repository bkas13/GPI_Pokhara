...
@section('content')
    ...
    <div style="background-color: #E9ECEF;">
        ...
        >
            ...
            <li class="active" style="color: black;">कार्यसमिती</li>
        </ol>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="inner-container">
                        <h1 class="inner-page-tite">बोर्ड निर्देशक</h1>
                        <p>
                                ...
                                @if($staffs->isNotEmpty())
                                    ...
                                    <div class="col-md-4 col-6">
                                        <div class="single-item">
                                            ...
                                            <div class="morebtn">
                                                <a href="{{ route('front.boardofdirectordetail',$staff->id) }}">
                                                    View More
                                                </a>
                                            </div>
