...
Route::group([
    ...
    Route::get('/messages','IndexController@principal_note')->name('principal-note');
    Route::get('/faqs','IndexController@faq')->name('faqs');
    ...
    // BoardOfDirector
    Route::get('/boardofdirectors','IndexController@boardofdirectors')->name('boardofdirectors');
    Route::get('/boardofdirectordetail/{id}','IndexController@boardofdirectordetail')->name('boardofdirectordetail');
    ...
    //career front
    Route::get('/careers','CareerController@career')->name('career');
    Route::get('/career/{id}/{date}','CareerController@singleCareer')->name('singleCareer');
...
Route::group([
    ...
    Route::get('/getstudentjson','IndexController@getStudentJson')->name('dashboard.student.json');
        ...
        Route::group([
            ...
            function () {
                Route::get('/', 'CareerController@index')->name('all');
                Route::get('/add', 'CareerController@add')->name('add');
                Route::post('/add', 'CareerController@store')->name('store');
                Route::get('/edit/{career_slug}', 'CareerController@edit')->name('edit');
                Route::post('/edit/{career_slug}', 'CareerController@update')->name('update');
                Route::post('/delete', 'CareerController@delete')->name('delete');
                Route::get('/changestatus/{career_id}', 'CareerController@changestatus')->name('changestatus');
    ...
    Route::group([
        ...
        function () {
            ...
            Route::get('/add', 'CourseCategoryController@add')->name('add');
            Route::post('/addSubmit', 'CourseCategoryController@addSubmit')->name('addSubmit');
            Route::get('/edit/{id}', 'CourseCategoryController@edit')->name('edit');
            Route::post('/editsubmit/{id}', 'CourseCategoryController@editsubmit')->name('editSubmit');
            Route::get('/delete/{id}', 'CourseCategoryController@delete')->name('delete');
        }
    );
    ...
    Route::group([
        ...
        Route::get('/','FAQController@index')->name('all');
        ...
        Route::post('/editsubmit/{id}','FAQController@editsubmit')->name('editSubmit');
        Route::get('/delete/{id}','FAQController@delete')->name('delete');
    });

    // BoardOfDirector
    Route::group([
        'prefix'=>'boardsofdirectors',
        'as' => 'boardsofdirector.',
    ], function(){
        Route::get('/','BoardOfDirectorController@index')->name('all');
        Route::get('/add','BoardOfDirectorController@add')->name('add');
        Route::post('/addSubmit','BoardOfDirectorController@store')->name('store');
        Route::get('/edit/{slug}','BoardOfDirectorController@edit')->name('edit');
        Route::post('/editsubmit/{update}','BoardOfDirectorController@update')->name('update');
        Route::get('/view/{slug}','BoardOfDirectorController@view')->name('view');
        Route::get('/delete/{slug}','BoardOfDirectorController@delete')->name('delete');
    });
    ...
    Route::group([
        ...
        Route::get('/','MessageController@index')->name('allmessages');
        Route::get('/add','MessageController@add')->name('add');
        Route::post('/addSubmit','MessageController@addSubmit')->name('addSubmit');
        Route::get('/edit/{id}','MessageController@edit')->name('edit');
        Route::post('/editsubmit/{id}','MessageController@editsubmit')->name('editSubmit');
